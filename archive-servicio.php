...
<section class="hero-section" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/torso.webp'); background-size: cover; background-position: center; background-attachment: fixed; min-height: 70vh; position: relative; color: white;">
    ...
    ?>
          <article class="service-card flip-card" onclick="this.classList.toggle('flipped')" style="perspective: 62.5rem; cursor: pointer; height: 25rem;">
            <div class="flip-card-inner" style="position: relative; width: 100%; height: 100%; text-align: center; transition: transform 0.8s; transform-style: preserve-3d;">
              ...
              <!-- CARA FRONTAL -->
              <div class="flip-card-front" style="position: absolute; width: 100%; height: 100%; backface-visibility: hidden; border-radius: 1rem; padding: 1.5rem; box-shadow: 0 0.5rem 2rem rgba(0, 0, 0, 0.2); backdrop-filter: color: #fceeeb; display: flex; flex-direction: column;">
                ...
                <?php endif; ?>
                <h3 class="service-title" style="margin-bottom: 0.75rem; font-size: 1.8rem; color: #fceeeb;"><?php the_title(); ?></h3>
              ...
              <div class="flip-card-back" style="position: absolute; width: 100%; height: 100%; backface-visibility: hidden; background: linear-gradient(135deg, #AA3000, #cc4000); border-radius: 1rem; padding: 1.5rem; box-shadow: 0 0.5rem 2rem rgba(0, 0, 0, 0.2); backdrop-filter: blur(15px); color: white; transform: rotateY(180deg); display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center;">
                ...
                <?php
                // Leer los campos personalizados - CORREGIDO: usar las claves correctas
                $precio_servicio = get_post_meta(get_the_ID(), '_servicio_precio', true);
                $duracion_servicio = get_post_meta(get_the_ID(), '_servicio_duracion', true);
                ?>
